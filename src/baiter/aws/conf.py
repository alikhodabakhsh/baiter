...
AWS_GROUP_NAME = "CFE_baiter_Group"
AWS_USERNAME = "cfe-baiter-user"

AWS_FILE_EXPIRE = 200
AWS_PRELOAD_METADATA = True
AWS_QUERYSTRING_AUTH = False

DEFAULT_FILE_STORAGE = 'baiter.aws.utils.MediaRootS3BotoStorage'
STATICFILES_STORAGE = 'baiter.aws.utils.StaticRootS3BotoStorage'
AWS_STORAGE_BUCKET_NAME = 'cfe-baiter'
